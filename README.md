...
Hyde Park and surrounding neighborshoods share an active community email list called Good Neighbors. Several times over the years, neighbors have exchanged information about strong smells noted by multiple people simultaneously. Between October 7 and November 3, 2025, neighbors spontaneously fielded an informal commnity survey. Neighbors submitted 39 smell self-reports over approximately three months in Q4 2025. Most described a **burning plastic or chemical smell**. This analysis correlates those reports with hourly weather data, PM2.5 measurements from a network of open source air quality sensors, and self-reported compliance records from nearby industrial facilities to determine plausible causes of the smell(s).
