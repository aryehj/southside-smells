...
The wind rose, timeline, and source-matching plots are generated by the notebook and will be available as figures once the notebook is run. (See `code/` for instructions.)
